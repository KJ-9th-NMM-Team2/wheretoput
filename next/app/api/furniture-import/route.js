 ...
 *   post:
 *     summary: 이미지를 3D 가구 모델로 변환
 *     description: 업로드된 이미지 파일을 GLB 또는 GLTF 형식의 3D 모델로 변환합니다.
 *     tags:
 *       - furniture
 *     requestBody:
 *       required: true
 ...
 *                 glbPath:
 *                   type: string
 *                   example: "/asset/furniture_1234567890.glb"
 *                 filename:
 *                   type: string
 *                   example: "furniture_1234567890.glb"
 *                 type:
 *                   type: string
 *                   enum: [glb, gltf]
 *                   example: "glb"
