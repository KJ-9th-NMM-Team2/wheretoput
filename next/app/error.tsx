    ...
    >
      <div className="block max-w-md w-full rounded-xl border border-amber-200 bg-white/90 backdrop-blur-sm p-8 text-center shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <a
            href="/"
            className="inline-block px-6 py-3 border border-[#1c140d] text-[#1c140d] font-semibold rounded-lg hover:bg-[#1c140d] hover:text-white transition-colors cursor-pointer"
          >
            홈으로 돌아가기
          </a>
        </div>
